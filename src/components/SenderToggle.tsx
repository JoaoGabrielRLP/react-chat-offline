...
export function SenderToggle({ sender, onToggle }: SenderToggleProps) {
  ...
  return (
    <button
      ...
      className="flex h-11 w-11 items-center justify-center rounded-full border border-stone-200 bg-stone-100 text-stone-700 transition-colors hover:bg-stone-200"
    >
